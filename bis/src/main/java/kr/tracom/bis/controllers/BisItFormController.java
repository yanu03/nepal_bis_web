    	...
    	if(mfile!=null){
	    	...
	    	if(fileSize<100){
		    	if(ext.equals("jpg") || ext.equals("png") || ext.equals("gif") || ext.equals("JPG") || ext.equals("PNG") || ext.equals("GIF")){
		    		...
		    		Image originalImage = ImageIO.read(upFile);
					int width=originalImage.getWidth(null);
					int height=originalImage.getHeight(null);
					
			   		if(width>526 || height>376){	//이미지 사이즈 초과시 새로그림
			   			width=526;
			       		height=376;
			        	...
			        	Image resizeImage = originalImage.getScaledInstance(width, height, Image.SCALE_SMOOTH);	
			          	BufferedImage newImage = new BufferedImage(width, height, BufferedImage.TYPE_INT_RGB );
			           	...
			           	ImageIO.write(newImage, "jpg", upFile);
			         }
		    	}else{
		    	...
		    	if(result == 1){
		    		List<Map<String,Object>> bitId=bisItFormService.getBitId();
		    		for(Map<String,Object> temp : bitId){
		    			Map<String,Object> ftpNotice=new HashMap<String,Object>();
		    			
		    			System.out.println("applyDate : "+fileMap.get("applyDate"));
		    			System.out.println("bitId : "+temp.get("bitId"));
		    			System.out.println("bitType : "+temp.get("bitType"));
		    			System.out.println("formType : "+Integer.parseInt(formType));
		    			System.out.println("storedFileName : "+storedFileName);
		    			
			    		ftpNotice.put("applyDate", fileMap.get("applyDate"));
			    		ftpNotice.put("deviceId", temp.get("bitId"));
			    		ftpNotice.put("deviceType", 3);
			    		ftpNotice.put("fileCode", 152);
			    		ftpNotice.put("ftpPath", "/BIT/FORM");
			    		ftpNotice.put("ftpFile", storedFileName);
			    		
			    		bfu.CommunicationUtil(ftpNotice,"ftp");
		    		}
