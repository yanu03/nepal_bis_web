...
<ax:layout name="modal">
    <jsp:attribute name="script">
      ...
      <script type="text/javascript" src="<c:url value='/assets/js/common/detail.js' />"></script>
        <script type="text/javascript" src="<c:url value='/assets/js/view/modal/companymodal.js' />"></script>
    </jsp:attribute>
              ...
              <ax:tbl clazz="ax-search-tbl" minWidth="500px">
                    <ax:tr>
                        ...
                        <ax:td label='bis.search' width="300px" labelWidth="80px">
                        	  <input type="text" name="Keyword"id="Keyword" onkeypress="if( event.keyCode==13 ){ACTIONS.dispatch(ACTIONS.SEARCH);}" class="form-control W120"/>      
                        </ax:td>
                    </ax:tr>
         	    </ax:tbl>
            </ax:form>
