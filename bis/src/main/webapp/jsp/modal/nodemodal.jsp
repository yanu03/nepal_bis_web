...
<ax:layout name="modal">
    <jsp:attribute name="script">
      ...
      <script type="text/javascript" src="<c:url value='/assets/js/common/detail.js' />"></script>
        <script type="text/javascript" src="<c:url value='/assets/js/view/modal/nodemodal.js' />"></script>
    </jsp:attribute>
    ...
    <jsp:body> 
        <ax:page-buttons>
           ...
           <button type="button" class="btn btn-primary" id="search" data-page-btn="search"><i class="cqc-magnifier"></i><ax:lang id="ax.admin.search"/></button>
                    ...
                    <ax:tr>
                        ...
                        <ax:td label='bis.division' width="250px" labelWidth="80px">
  						 	<select class="form-control" id="" name="" data-ax-path="Select" >
								 <option value="nodeName"><ax:lang id="bis.node.nodename"/></option>
