...
<ax:layout name="base">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='/assets/js/view/managed/manage-parameter.js' />"></script>
    </jsp:attribute>
            ...
            <ax:form name="searchView0">
                <ax:tbl clazz="ax-search-tbl" minWidth="500px">
					<ax:tr>
                        ...
                        <ax:td label='ax.promotion.search.searchDiv' width="240px" labelWidth="80px" >
                        	<select id="searchDiv" data-ax-path="searchDiv" style="vertical-align: middle;" class="form-control">
                        		<option value="PARAM_NAME"><ax:lang id="ax.code.paramName"/></option>
                        		<option value="PARAM_ID"><ax:lang id="ax.code.paramId"/></option>
	                        </select>
                        </ax:td>
