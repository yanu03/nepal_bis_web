...
<ax:layout name="modal">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='/assets/js/view/promotion/promotion-formmodal.js' />"></script>
        <script type="text/javascript" src="<c:url value='/assets/js/common/detail.js' />"></script>
    </jsp:attribute>
    <jsp:attribute name="header">
        <h1 class="title">
            <i class="cqc-browser"></i>
            <ax:lang id="ax.promotion.form.list"/>
        </h1>
    </jsp:attribute>
    <jsp:body>
        <ax:page-buttons>
                ...
                <ax:tbl clazz="ax-search-tbl" minWidth="500px">
                      <ax:tr>
                       <%-- <ax:td label='ax.promotion.search.useYn' width="180px" labelWidth="80px">
                        ...
                        <ax:td label='ax.promotion.search.searchDiv' width="200px" labelWidth="80px">
                        ...
                        <ax:td label='ax.promotion.search.searchData' width="180px" labelWidth="80px">
        ...
        <%-- <ax:split-layout name="ax1" orientation="vertical">
            <ax:split-panel width="*" style="padding-right: 0px;">
				...
				<img id="selectFile"  class="img_scale" alt="Image" src="" style="display:none; width:500px; height:300px;">
