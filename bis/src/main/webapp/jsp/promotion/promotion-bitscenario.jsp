...
<ax:layout name="base">
    <jsp:attribute name="script">
        ...
        <ax:script-lang key="bis" var="LANG" />
        <script type="text/javascript" src="<c:url value='/assets/js/view/promotion/promotion-bitscenario.js' />"></script>
    ...
    <jsp:body>
        ...
        <div role="page-header">
            <ax:form name="searchView0">
                <ax:tbl clazz="ax-search-tbl" minWidth="800px">
                    <ax:tr>
                   ...
                   <%--  <ax:tbl clazz="ax-form-tbl" minWidth="500px">
                    ...
                    <div class="ax-button-group"  data-fit-height-aside="grid-view-02">
                        <div class="left">
                            <h3>
                                <i class="cqc-list"></i>
                                <ax:lang id="ax.promotion.bit.list"/></h3>
                        </div>
                        <div class="right">
                          ...
                          <%--   <button type="button" class="btn btn-default" data-grid-view-02-btn="item-control">
                                <ax:lang id="bis.control.tr"/>
                            </button>  --%>
