<%@ tag import="kr.tracom.bis.utils.CommonCodeUtils" %>
<%@ tag import="kr.tracom.bis.security.*" %>
...
<div id="ax-frame-root" class="<c:if test="${config.layout.leftSideMenu eq 'visibleno'}">show-aside</c:if>" data-root-container="true">
    <jsp:doBody/>
    ...
    <div class="ax-frame-header">
        <div class="ax-split-col" style="height: 100%;">
            <c:if test="${config.layout.leftSideMenu eq 'visibleno'}">
            ...
            <%--<div class="ax-split-panel cell-logo">
                <a href="${pageContext.request.contextPath}/jsp/main.jsp">
                    <img src="/assets/images/butanLogo.png" style="width:100%; margin-left:5px;"/>
