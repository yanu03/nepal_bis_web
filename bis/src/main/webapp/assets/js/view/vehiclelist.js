...
var ACTIONS = axboot.actionExtend(fnObj, {
  ...
  AREACODE_MODAL: function (caller, act, data) {
	  ...
	  COMPANY_MODAL: function (caller, act, data) {

		  	 axboot.modal.open({
		           modalType: "COMPANY-MODAL",
		           param: "",
		           sendData: function(){
		           ...
		           callback: function (data) {
		          	 ...
		          	 var json = caller.formView01.getData();
		          	 json.companyId = data.companyId;
		          	 json.companyName = data.companyName;
		          	 caller.formView01.setData(json);
		          	this.close();
		           }
		       });
...
$('.company_button').click(function() {
	 ACTIONS.dispatch(ACTIONS.COMPANY_MODAL);
});
...
$('#excelExport').click(function(){
	...
	excelExport.excel("VehicleList.xls");
});
