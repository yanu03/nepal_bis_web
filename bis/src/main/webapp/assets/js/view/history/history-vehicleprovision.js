...
var ACTIONS = axboot.actionExtend(fnObj, {
    PAGE_SEARCH: function (caller, act, data) {
    	...
    	if(rightItem.length==0){
        	...
        	axboot.ajax({
                type: "PUT",
                url: "/api/v1/bisMaHistory/serviceVehicle",
...
fnObj.gridView01 = axboot.viewExtend(axboot.gridView, {
    initView: function () {
    	...
    	var swapColumns=[
    			...
    			{key: "plateNumber", label: BIS("bis.vehicle.platenumber"), width: 100, align: "center", editor: {type: "text", disabled: "notCreated"}},
...
fnObj.gridView02 = axboot.viewExtend(axboot.gridView, {
    initView: function () {
    	...
    	var swapColumns=[
    			...
    			{key: "vehicleName", label: COL("ax.history.vehicleName"), width: 120, align: "center", editor: {type: "text", disabled: "notCreated"}},
    			{key: "systemDate", label: COL("ax.history.systemDate"), width: 120, align: "center", editor: {type: "text", disabled: "notCreated"}},
                {key: "preplateNumber", label: COL("ax.history.preplateNumber"), width: 130, align: "center", editor: {type: "text", disabled: "notCreated"}},
                {key: "nextplateNumber", label: COL("ax.history.nextplateNumber"), width: 130, align: "center", editor: {type: "text", disabled: "notCreated"}},
                {key: "predistanceGap", label: COL("ax.history.predistanceGap"), width: 130, align: "center", editor: {type: "text", disabled: "notCreated"}},
                {key: "nextdistanceGap", label: COL("ax.history.nextdistanceGap"), width: 130, align: "center", editor: {type: "text", disabled: "notCreated"}},
                {key: "prelocationNumber", label: COL("ax.history.prelocationNumber"), width: 130, align: "center", editor: {type: "text", disabled: "notCreated"}},
                {key: "pretimeGap", label: COL("ax.history.pretimeGap"), width: 120, align: "center", editor: {type: "text", disabled: "notCreated"}},
                {key: "nexttimeGap", label: COL("ax.history.nexttimeGap"), width: 120, align: "center", editor: {type: "text", disabled: "notCreated"}}
	        ]
