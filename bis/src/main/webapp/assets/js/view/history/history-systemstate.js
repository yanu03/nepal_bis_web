...
var ACTIONS = axboot.actionExtend(fnObj, {
    PAGE_SEARCH: function (caller, act, data) {
    	...
    	if(rightItem.length==0){
        	...
        	axboot.ajax({
                type: "PUT",
                url: "/api/v1/bisMaHistory/systemState",
...
fnObj.gridView02 = axboot.viewExtend(axboot.gridView, {
    initView: function () {
    	...
    	var swapColumns=[
                ...
                {key: "systemDate", label: COL("ax.history.systemDate"), width: 100, align: "center", editor: {type: "text", disabled: "notCreated"}},
                {key: "stateCode", label: COL("ax.history.stateCode"), width: 90, align: "center", editor: {type: "text", disabled: "notCreated"}, formatter: function () {
           		var detailCode = getDetailCode("STATE_CODE",this.item.stateCode);
                   return detailCode;
                  }},
                {key: "stateValue", label: COL("ax.history.stateValue"), width: 90, align: "center", editor: {type: "text", disabled: "notCreated"}}
	        ]
        var _this = this;
        this.target = axboot.gridBuilder({
        	showLineNumber:false,
...
$('#excelExport').click(function(){
	...
	excelExport.excel("SystemStateHistory.xls");
});
