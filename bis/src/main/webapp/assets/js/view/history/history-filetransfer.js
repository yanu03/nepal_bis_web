...
var ACTIONS = axboot.actionExtend(fnObj, {
    PAGE_SEARCH: function (caller, act, data) {
    	...
    	if(rightItem.length==0){
        	...
        	axboot.ajax({
                type: "PUT",
                url: "/api/v1/bisMaHistory/fileSend",
    ...
    initView: function () {
    	...
    	if(temp.Select=="bitName"){
    		...
    		swapColumns= [
	            ...
	            {key: "terminalType", label: BIS("bis.terminal.terminaltype"), width: 150, align: "center", editor: {type: "text", disabled: "notCreated"}, formatter: function () {
...
fnObj.gridView02 = axboot.viewExtend(axboot.gridView, {
    initView: function () {
    	...
    	if(temp.Select=="bitName"){
	    	swapColumns=[
	    			{key: "sessionId", label: COL("ax.history.sessionId"), width: 120, align: "center", editor: {type: "text", disabled: "notCreated"}},
	    			{key: "bitName", label: COL("ax.history.clientName"), width: 100, align: "center", editor: {type: "text", disabled: "notCreated"}},
	    			{key: "sysDt", label: COL("ax.history.sysDt"), width: 120, align: "center", editor: {type: "text", disabled: "notCreated"}},
	                //{key: "plfId", label: COL("ax.history.plfId"), width: 130, align: "center", editor: {type: "text", disabled: "notCreated"}},
	                {key: "fileName", label: COL("ax.history.fileName"), width: 200, align: "center", editor: {type: "text", disabled: "notCreated"}},
	                //{key: "fileCd", label: COL("ax.history.fileCd"), width: 120, align: "center", editor: {type: "text", disabled: "notCreated"}},
	                //{key: "sendType", label: COL("ax.history.sendType"), width: 120, align: "center", editor: {type: "text", disabled: "notCreated"}},
	                {key: "filePath", label: COL("ax.history.filePath"), width: 200, align: "center", editor: {type: "text", disabled: "notCreated"}},
	    			//{key: "filePointer", label: COL("ax.history.filePointer"), width: 120, align: "center", editor: {type: "text", disabled: "notCreated"}},
		            {key: "sendState", label: COL("ax.history.sendState"), width: 130, align: "center", editor: {type: "text", disabled: "notCreated"}},
		            {key: "sendStDt", label: COL("ax.history.sendStDt"), width: 120, align: "center", editor: {type: "text", disabled: "notCreated"}},
	                {key: "sendEdDt", label: COL("ax.history.sendEdDt"), width: 130, align: "center", editor: {type: "text", disabled: "notCreated"}}
		     ];
    	}else{
    		swapColumns=[
    			{key: "sessionId", label: COL("ax.history.sessionId"), width: 120, align: "center", editor: {type: "text", disabled: "notCreated"}},
    			{key: "plateNumber", label: COL("ax.history.clientName"), width: 100, align: "center", editor: {type: "text", disabled: "notCreated"}},
    			{key: "sysDt", label: COL("ax.history.sysDt"), width: 120, align: "center", editor: {type: "text", disabled: "notCreated"}},
                //{key: "plfId", label: COL("ax.history.plfId"), width: 130, align: "center", editor: {type: "text", disabled: "notCreated"}},
                {key: "fileName", label: COL("ax.history.fileName"), width: 200, align: "center", editor: {type: "text", disabled: "notCreated"}},
                //{key: "fileCd", label: COL("ax.history.fileCd"), width: 120, align: "center", editor: {type: "text", disabled: "notCreated"}},
