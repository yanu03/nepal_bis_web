...
fnObj.tabView = axboot.viewExtend({
    ...
    initView: function () {
        ...
        var menu = new ax5.ui.menu({
            ...
            items: [
            	 {icon: '<i class="cqc-ccw"></i>', label: 'Refresh current tab', action: "reload"},
                 {icon: '<i class="cqc-cancel3"></i>', label: 'Close current tab', action: "close"},
                 {icon: '<i class="cqc-cancel"></i>', label: 'Close without current tab', action: "closeAnother"},
