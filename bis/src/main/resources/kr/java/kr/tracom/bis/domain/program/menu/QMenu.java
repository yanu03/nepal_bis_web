...
public class QMenu extends EntityPathBase<Menu> {
    ...
    private static final long serialVersionUID = -2001707099L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QMenu menu = new QMenu("menu");

    public final kr.tracom.bis.domain.QBaseJpaModel _super = new kr.tracom.bis.domain.QBaseJpaModel(this);
    ...
    public final kr.tracom.bis.domain.program.QProgram program;
    ...
    public QMenu(Class<? extends Menu> type, PathMetadata metadata, PathInits inits) {
        ...
        this.program = inits.isInitialized("program") ? new kr.tracom.bis.domain.program.QProgram(forProperty("program")) : null;
    }
